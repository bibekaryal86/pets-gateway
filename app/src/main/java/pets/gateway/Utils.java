...
public class Utils {
    ...
    private static String getPetsServiceAuthConfig() {
        String username = System.getProperty(BASIC_AUTH_USR_PETSSERVICE) != null
                ? System.getProperty(BASIC_AUTH_USR_PETSSERVICE)
                : System.getenv(BASIC_AUTH_USR_PETSSERVICE);
        String password = System.getProperty(BASIC_AUTH_PWD_PETSSERVICE) != null
    ...
    private static String getPetsDatabaseAuthConfig() {
        String username = System.getProperty(BASIC_AUTH_USR_PETSDATABASE) != null
                ? System.getProperty(BASIC_AUTH_USR_PETSDATABASE)
                : System.getenv(BASIC_AUTH_USR_PETSDATABASE);
        String password = System.getProperty(BASIC_AUTH_PWD_PETSDATABASE) != null
